...
@Controller     
@RequestMapping(path="/tool/drill") 
public class DrillController extends BaseController{
	...
	public ResponseEntity<Drill> add (
            @RequestParam(required = true, value = "data") final String data
            ) throws JsonParseException, JsonMappingException, IOException {
		
		Drill s =s_mapper.readValue(data, Drill.class);
		s = (Drill)service.add(s);
		
		return new ResponseEntity<Drill>(s, HttpStatus.CREATED);
	}
